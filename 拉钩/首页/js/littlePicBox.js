...
(function(){
    ...
    var aList1=sBox.getElementsByTagName("a");
    var oDivs=sBox.getElementsByTagName("div");
    ...
    function move(){
        ...
        for(var i=0;i<aList1.length;i++){
            ...
            ele.onmouseleave=function(){
                ...
                var y= (e.pageY-offset(this).t-h/2);
                if(x>y&&x>-y){
                    animate(b,{left:114,top:0},150);
                }else if(x>y&&x<=-y){
                    animate(b,{left:0,top:-114},150);
                } else if(x<=y&&x<-y){
                    animate(b,{left:-114,top:0},150);
                }else{
                    animate(b,{left:0,top:114},150);
